...
func FetchFeeds(ctx context.Context, sources []FeedSource, keywords []string, strictFilter bool) FetchResult {
	start := time.Now()
	...
	g.SetLimit(50) // Max 50 concurrent HTTP requests
